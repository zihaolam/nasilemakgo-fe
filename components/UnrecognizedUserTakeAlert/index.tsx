const UnrecognizedUserTakeAlert = () =>
    <div className="">
        <div id="alert" className="w-3/12 bg-white py-4 md:py-0 dark:bg-gray-800 shadow rounded flex flex-col items-center md:flex-row  justify-between">
            <div className="flex flex-col items-center md:flex-row">
                ...
                <p className="mr-2 text-base font-bold text-gray-800 dark:text-gray-100 mt-2 md:my-0">Alert</p>
                <div className="h-1 w-1 bg-gray-300 dark:bg-gray-700 rounded-full mr-2 hidden xl:block" />
                <p className="text-sm lg:text-base dark:text-gray-400 text-gray-600 lg:pt-1 xl:pt-0 sm:mb-0 mb-2 text-center sm:text-left">Unrecognized user has taken 2</p>
            </div>
...
export default UnrecognizedUserTakeAlert